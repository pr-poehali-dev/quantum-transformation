        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Общайся на Android и PC</p>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["общий", "новости", "обновления", "поддержка"].map((channel) => (
                    <div
                      key={channel}
              ...
              <div>
                ...
                <div className="mt-1 space-y-0.5">
                  {["Голосовой чат", "Видеозвонок"].map((channel) => (
                    <div
                      key={channel}
                      className="flex items-center gap-1.5 px-2 py-1 rounded text-[#8e9297] hover:text-[#dcddde] hover:bg-[#393c43] cursor-pointer"
                    >
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Добро пожаловать в мессенджер нового поколения</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Добро пожаловать!</strong> Мессенджер, который всегда рядом — на Android и PC.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что умеет мессенджер:</h3>
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        <li>📱 Мобильное приложение для Android</li>
                        <li>💻 Десктопная версия для Windows и Mac</li>
                        <li>🔄 Синхронизация сообщений в реальном времени</li>
                        <li>🔒 Сквозное шифрование переписки</li>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Только скачала приложение — всё очень удобно! Синхронизация с ПК работает мгновенно 🚀
                  </div>
                    ...
                    <div className="pt-4 sm:pt-6 px-3 sm:px-4 pb-3 sm:pb-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="text-white font-semibold text-xs sm:text-sm mb-1">Android приложение</div>
                            <div className="text-[#dcddde] text-xs sm:text-sm mb-1">Сообщения синхронизированы</div>
                            <div className="text-[#b9bbbe] text-xs sm:text-sm mb-2">Samsung Galaxy S24</div>
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-[#3ba55c] rounded-full animate-pulse"></div>
                              <span className="text-[#3ba55c] text-xs font-medium">Активно сейчас</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base mb-3">
                    Подключился с ноутбука — история чатов сразу подтянулась. Наконец-то нормальный мессенджер!
                  </div>

                  {/* CTA блок */}
                  <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 max-w-md">
                    <h3 className="text-white font-bold text-base sm:text-lg mb-2">Скачать бесплатно</h3>
                    <p className="text-[#b9bbbe] text-xs sm:text-sm mb-4">
                      Доступно для Android и PC. Зарегистрируйся за 30 секунд.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                      <Button className="bg-[#5865f2] hover:bg-[#4752c4] text-white rounded flex items-center justify-center gap-2">
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Почему наш мессенджер?</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    {
                      icon: <Zap className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Моментальная доставка",
                      desc: "Сообщения доходят за миллисекунды",
                    },
                    {
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  {
                    name: "Мария",
                    status: "Пишет с Android",
                    avatar: "М",
                    color: "from-purple-500 to-pink-500",
                  },
                  { name: "Иван", status: "В сети с PC", avatar: "И", color: "from-green-500 to-blue-500" },
                  { name: "Алексей", status: "Создаёт мессенджер", avatar: "А", color: "from-blue-500 to-purple-500" },
                ].map((user, index) => (
